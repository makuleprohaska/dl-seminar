...
learning. The same protocol is applied to each teacher for comparison. For BACH and MHIST we report
accuracy as mean $\pm$ standard deviation over five runs; the slide-level CAMELYON16 probe is a
single run. The best result in each column is in bold.
...
tasks: it places second behind Virchow2 on MHIST and CAMELYON16 and third on BACH, and it surpasses
the $1.1$\,B-parameter H-optimus-1 on every task while using $7$--$13\times$ fewer parameters than
any teacher.
...
\midrule
UNI2-h~\cite{uni}        & 681\,M & \textbf{91.46 $\pm$ 0.29} & 82.47 $\pm$ 0.13 & 88.37 \\
Virchow2~\cite{virchow2} & 632\,M & 88.00 $\pm$ 0.76 & \textbf{86.06 $\pm$ 0.24} & \textbf{96.12} \\
H-optimus-1~\cite{hoptimus} & 1.1\,B & 78.07 $\pm$ 0.70 & 83.66 $\pm$ 0.32 & 92.25 \\
\midrule
Student (ours)           & 86.6\,M & 86.54 $\pm$ 0.48 & 84.33 $\pm$ 0.08 & 93.80 \\
\bottomrule
\end{tabular}
\end{center}
