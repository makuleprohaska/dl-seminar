...
accuracy (MHIST); the slide-level CAMELYON16 probe is a single train/test run. The best result in
...
Virchow2~\cite{virchow2} & 632\,M & 88.00 $\pm$ 0.76 & \textbf{86.11 $\pm$ 0.05} & \textbf{96.12} \\
H-optimus-1~\cite{hoptimus} & 1.1\,B & 78.07 $\pm$ 0.70 & 83.79 $\pm$ 0.13 & 92.25 \\
\midrule
Student (ours)           & 86.6\,M & 85.16 $\pm$ 0.54 & 84.39 $\pm$ 0.04 & 93.80 \\
\bottomrule
\end{tabular}
\end{center}
